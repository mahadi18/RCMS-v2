                ...
                <div class="row spacer-top">
                    <div class="col-lg-12">
                        ...
                        <select name="organization[]" class="multi-select" multiple="" id="my_multi_select3">
                            ...
                            {
                            ?>
                            <option value="{{$organization->id}}" <?php echo $selected; ?>>{{$organization->name}}, {{$organization->org_type($organization->org_type)}}, {{$organization->district->name}}, {{$organization->country_name($organization->country)}}</option>
                            <?php } ?>
                            @endforeach
                        </select>
